...
$workflowPaths = @('workflows/PROJECT_CONNECT_PROMPT.md', 'workflows/PROJECT_AUDIT_PROMPT.md', 'workflows/PROJECT_STUDY.md')
...
Write-Host 'Portable boundary tests passed: 12 assertions.' -ForegroundColor Green
